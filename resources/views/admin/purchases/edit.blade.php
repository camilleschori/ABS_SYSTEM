...
@section('content')
    ...
    <div id="app">
        ...
        <div id="main" class="vh-100 overflow-auto">
            <x-breadcrumb sub1="المشتريات" sub1url="{{ route('admin.purchases.index') }}" sub2="تعديل فاتورة" />
            <div class="card p-4">
            ...
            @endif
                ...
                <x-form action="{{ route('admin.purchases.update', $invoice->id) }}" :back="$back" method="PUT">
                    ...
                    <div class="col-12">
                        ...
                        <a href="{{ route('admin.purchases.print', $invoice->id) }}" class="btn btn-primary mb-2" target="_blank"><i class="bi bi-printer"></i> طباعة</a>
