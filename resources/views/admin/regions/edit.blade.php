...
@section('content')
    <div id="app">
        ...
        <div id="main" class="vh-100 overflow-auto">
            <x-breadcrumb sub1="المناطق" sub1url="{{ route('admin.regions.index') }}" sub2="تعديل منطقة" />
            <div class="card p-5">
                <x-form action="{{ route('admin.regions.update', $region->id) }}" :back="$back" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div id="type-specific-inputs" class="col-md-7">
                        ...
                        <div id="province-select" style="display: none;">
                            <x-form-input name="province_id" label="المحافظة" type="select" class="col-md-12"
                                :options="$province_options" value="{{ $region->parent_id }}" />
                        </div>

                        <!-- Area select (for sub_area) -->
                        <div id="area-select" style="display: none;">
                            <x-form-input name="area_id" label="المنطقة" type="select" class="col-md-12" :options="$area_options"
