...
@section('content')
    ...
    <div id="app">
        ...
        <div id="main" class="vh-100 overflow-auto">
            <x-breadcrumb sub1="المبيعات" sub1url="{{ route('admin.sales.index') }}" sub2="انشاء فاتورة" />
            <div class="card p-4">
            ...
            @endif
                ...
                <x-form action="{{ route('admin.sales.store') }}" :back="$back" method="POST">
